...
src_md = os.path.join(playbooks_dir, "plan_ajustes_anti_humo_zero_assumption_paymind.md")
docx_name = "21_Plan_Ajustes_Anti_Humo_Zero_Assumption_Paymind.docx"
...
for d in desktop_dirs:
    if os.path.exists(d):
        ...
        print(f"[OK] Creado documento Word de Plan de Ajustes Anti-Humo: {dst}")

print("Conversión de Plan de Ajustes Anti-Humo completada.")
