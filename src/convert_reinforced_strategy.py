...
src_md = os.path.join(playbooks_dir, "estrategia_reforzada_crecimiento_paymind_2026.md")
docx_name = "19_Estrategia_Reforzada_Crecimiento_Paymind_2026.docx"
...
for d in desktop_dirs:
    if os.path.exists(d):
        ...
        print(f"[OK] Creado documento Word de Estrategia Reforzada: {dst}")

print("Conversión de Estrategia Reforzada completada.")
