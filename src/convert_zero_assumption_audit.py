...
src_md = os.path.join(playbooks_dir, "auditoria_zero_assumption_matriz_evidencia_manus.md")
docx_name = "18_Auditoria_Zero_Assumption_Matriz_Evidencia_Manus.docx"
...
for d in desktop_dirs:
    if os.path.exists(d):
        ...
        print(f"[OK] Creado documento Word de Auditoria Zero-Assumption: {dst}")

print("Conversión de Auditoría Zero-Assumption completada.")
