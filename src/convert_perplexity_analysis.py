...
src_md = os.path.join(playbooks_dir, "analisis_estrategico_infraestructura_kioskos_perplexity.md")
docx_name = "17_Analisis_Estrategico_Infraestructura_Kioskos_Perplexity.docx"
...
for d in desktop_dirs:
    if os.path.exists(d):
        ...
        print(f"[OK] Creado documento Word de Perplexity: {dst}")

print("Conversión de análisis de Perplexity completada.")
