...
src_md = os.path.join(playbooks_dir, "impacto_regulatorio_anteproyecto_cnbv_banxico_paymind.md")
docx_name = "22_Impacto_Regulatorio_Anteproyecto_CNBV_Banxico_Paymind.docx"
...
for d in desktop_dirs:
    if os.path.exists(d):
        ...
        print(f"[OK] Creado documento Word de Impacto Regulatorio: {dst}")

print("Conversión de Impacto Regulatorio completada.")
